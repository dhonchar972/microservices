...
import ua.optimagrowth.license.model.utils.ErrorMessage;
import ua.optimagrowth.license.model.utils.ResponseWrapper;
import ua.optimagrowth.license.model.utils.RestErrorList;
...
public class ExceptionController extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ResponseWrapper> handleIOException(HttpServletRequest request, RuntimeException exception){
    	...
    	RestErrorList errorList = new RestErrorList(HttpStatus.NOT_ACCEPTABLE, new ErrorMessage(exception.getMessage(),
				exception.getMessage()));
        ResponseWrapper responseWrapper = new ResponseWrapper(null, singletonMap("status",
				HttpStatus.NOT_ACCEPTABLE), errorList);
